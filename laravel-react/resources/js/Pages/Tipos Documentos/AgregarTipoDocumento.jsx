...
const AgregarDireccion = ({auth}) => {
    ...
    const submit = (e) => {
        e.preventDefault()
        onOpenProgress()
        post(route('tipo-documento.store'),{
    ...
    return (
        ...
        header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Agregar tipo de documento</h2>}>
            <Head title='Agregar tipo de documento'></Head>
            <TitleTemplate>Agregar tipo de documento</TitleTemplate>
